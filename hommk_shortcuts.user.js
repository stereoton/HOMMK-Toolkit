...
// Imports
if('undefined' == typeof __PAGE_SCOPE_RUN__ && !$('GreasemonkeyPageScopeRunner')) new Asset.javascript('http://userscripts.org/scripts/source/68059.user.js', {'id': 'GreasemonkeyPageScopeRunner'});
if(!window.localStorage && !$('MozillaLocalStorage')) new Asset.javascript('http://pastebin.com/raw.php?i=zrfAFeBc', {'id': 'MozillaLocalStorage'});
if("undefined" == typeof $ES && !$('MootoolsElementSelectors')) new Asset.javascript('http://pastebin.com/raw.php?i=2G8yXznG', {'id': 'MootoolsElementSelectors'});
if("undefined" == typeof Scroller && !$('MootoolsScroller')) new Asset.javascript('http://pastebin.com/raw.php?i=W0gZUcpe', {'id': 'MootoolsScroller'});
if(!$('HkPrototypes')) new Asset.javascript('http://pastebin.com/raw.php?i=NBX5T7pp', {'id': 'HkPrototypes'});
if("undefined" == typeof HkStylesGeneric && !$('HkStylesGeneric')) new Asset.javascript('https://github.com/gelgamek/HOMMK-Toolkit/raw/master/hommk_styles.user.js', {'id': 'HkStylesGeneric'});
